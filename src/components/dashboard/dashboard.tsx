    ...
    <div className="space-y-8">
      <Grid numItemsSm={1} numItemsMd={2} numItemsLg={4} className="gap-6">
        {highlightCards.map(({ title, value, description, icon: Icon, delta, deltaType }) => (
          <Card key={title} decoration="top" decorationColor="emerald" className="space-y-4">
            <Flex justifyContent="between" alignItems="start" className="gap-4">
              <div>
                <Text className="text-sm text-tremor-content-subtle">{title}</Text>
                <Metric className="mt-1 text-tremor-content-strong">{value}</Metric>
              </div>
      ...
      <Grid numItemsSm={1} numItemsLg={3} className="gap-6">
        <Card className="space-y-4 lg:col-span-2" decoration="top" decorationColor="emerald">
          <Flex justifyContent="between" alignItems="center">
            <div>
        ...
        <AITipsCard className="lg:col-span-1" />
      </Grid>

      <Grid numItemsSm={1} numItemsLg={3} className="gap-6">
        <Card className="space-y-4 lg:col-span-2" decoration="top" decorationColor="indigo">
          <Flex justifyContent="between" alignItems="center">
            <div>
              <Title>Padrão de Sono</Title>
              <Text className="text-sm text-tremor-content-subtle">
        ...
        <Card className="space-y-4" decoration="top" decorationColor="indigo">
          <Title>Estrutura da última noite</Title>
          <Text className="text-sm text-tremor-content-subtle">
      ...
      {todayMetrics ? (
        <div className="space-y-4">
          <Title>Pilares avançados de saúde</Title>
          <Text className="text-sm text-tremor-content-subtle">
